package com.github.chembl.test;
/**
 * 
 */
 ...
 */
public class ChemblWebTest extends AbstractQueryAllWebTest
{
    private static final Logger LOGGER = LoggerFactory.getLogger(ChemblWebTest.class);
    ...
    {
        return "http://localhost:9090/chembl-rdf-test/";
    }
